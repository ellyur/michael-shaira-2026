        ...
        >
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 md:w-5 md:h-5 rounded-full flex items-center justify-center z-20"
                style={{
                    ...
                    boxShadow: '0 0 0 4px rgba(100, 150, 200, 0.2)'
                }}
            >
                    ...
                    <>
                        ...
                        >
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] md:text-xs text-muted-foreground/80 leading-tight font-satoshi">
...
const timelineEvents: TimelineEvent[] = [
    {
        time: "2:00 PM",
        event: "ARRIVAL AT CHURCH",
        description: "Arrive at Minor Basilica and Parish of St. John the Baptist for the ceremony.",
        icon: Church,
        hueA: 40,
        hueB: 40,
    },
    {
        ...
        description: "Witness Michael and Shaira exchange their vows and promises.",
        icon: Heart,
        hueA: 40,
        hueB: 40,
    },
    ...
    },
    {
        time: "4:30 PM",
        event: "GRAZING",
        description: "Enjoy light refreshments and appetizers.",
        icon: Utensils,
        hueA: 40,
        hueB: 40,
    },
    ...
    },
    {
        time: "7:00 PM",
        event: "DINNER",
        description: "Enjoy a delicious dinner with loved ones.",
        icon: Wine,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "9:00 PM",
        event: "PARTY",
        description: "Dance and celebrate the night away with us.",
        icon: PartyPopper,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "10:00 PM",
        event: "SEND OFF",
        description: "Say goodbye as we celebrate our new chapter together.",
        icon: Heart,
        hueA: 40,
        hueB: 40,
    },
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
                ...
                <div className="absolute bottom-1/3 left-1/5 w-16 h-16 border border-accent/30 rounded-full"></div>
                <div className="absolute top-1/2 left-1/6 w-6 h-6 bg-accent/40 rounded-full animate-pulse"></div>
                <div className="absolute bottom-1/2 right-1/5 w-8 h-8 bg-accent/40 rotate-45"></div>
            </div>
            {/* Floating Elements */}
            ...
            <div className="relative z-10 text-center mb-12">
                ...
                >
                    ...
                    <p className="max-w-2xl mx-auto text-[#0b0b0b] font-satoshi">
            ...
            <div className="relative max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="absolute left-1/2 top-0 bottom-0 w-0.5 -translate-x-1/2" style={{ background: 'rgba(100, 150, 200, 0.3)' }}></div>
            ...
            <motion.div 
                ...
                transition={{ duration: 0.8, ease: "easeOut" }}
            >
                <div className="bg-card/60 backdrop-blur-sm border border-accent/30 rounded-2xl p-8 shadow-lg">
                    <div className="mb-4">
                    ...
                    <p className="text-sm md:text-base text-muted-foreground mb-4 font-satoshi">
                        Help us capture moments on our special day by using these hashtags:
                    </p>
                    <div className="space-y-3">
                        <div className="inline-block border-2 border-accent rounded-lg px-4 md:px-6 py-3 bg-[#ffffff] max-w-full">
                            <p className="text-accent text-sm sm:text-base md:text-lg break-all" style={{ fontFamily: 'Telma, sans-serif' }} data-testid="text-hashtag-1">#OffiSHAIllymeantforMIKE</p>
                        </div>
                        <div className="inline-block border-2 border-accent rounded-lg px-4 md:px-6 py-3 bg-[#ffffff] max-w-full block">
                            <p className="text-accent text-sm sm:text-base md:text-lg break-all" style={{ fontFamily: 'Telma, sans-serif' }} data-testid="text-hashtag-2">#letsMIKEitforeverwithSHAI</p>
                        </div>
                    </div>
                </div>
            </motion.div>
