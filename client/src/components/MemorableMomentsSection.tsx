...
const prenup1 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386106/prenup1_b6ki3l.jpg';
const prenup2 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386107/prenup2_sifmtg.jpg';
const prenup3 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386108/prenup4_lbfqvt.jpg';
const prenup4 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386108/prenup5_xcpzk1.jpg';
const prenup5 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386109/prenup7_vkcevc.jpg';
const prenup6 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386109/prenup8_dbmqk9.jpg';
const prenup7 = 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386109/prenup5_xcpzk1.jpg';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-5xl font-display font-light italic mb-8 text-[#3d668f]" data-testid="text-prenup-photos-title">
