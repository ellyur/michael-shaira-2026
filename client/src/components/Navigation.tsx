...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-accent/30 shadow-soft transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <img 
              src="https://res.cloudinary.com/dbrsm7rkk/image/upload/v1764394361/image-removebg-preview_1_hrelgp.png" 
              alt="J&C Logo" 
          ...
          <div className="md:hidden">
            <Button
              ...
              className="text-accent hover:bg-primary/20 hover:text-accent/80"
            >
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-background/95 backdrop-blur-md border-b border-accent/30">
            {navItems.map((item) => (
              <button
                key={item.name}
                onClick={() => scrollToSection(item.href)}
