    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            <div className="absolute top-0 left-0 w-16 h-16 border-l-2 border-t-2 border-accent opacity-20"></div>
            <div className="absolute top-0 right-0 w-16 h-16 border-r-2 border-t-2 border-accent opacity-20"></div>
            <div className="absolute bottom-0 left-0 w-16 h-16 border-l-2 border-b-2 border-accent opacity-20"></div>
            <div className="absolute bottom-0 right-0 w-16 h-16 border-r-2 border-b-2 border-accent opacity-20"></div>
            ...
            <div className="relative text-center space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-foreground/80 leading-relaxed text-base md:text-lg italic font-satoshi px-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8">
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-2 border-border hover:border-accent text-foreground hover:text-accent bg-transparent hover:bg-muted font-medium py-5 px-6 rounded-lg transition-all duration-300 text-base"
              ...
              <div className="flex items-center justify-center gap-2 pt-4">
                <Heart className="w-3 h-3 text-accent fill-accent opacity-50" />
                <div className="w-1 h-1 rounded-full bg-accent opacity-50"></div>
                <Heart className="w-3 h-3 text-accent fill-accent opacity-50" />
              </div>
            </div>
          </motion.div>
