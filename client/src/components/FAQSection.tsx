    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg font-satoshi text-foreground max-w-2xl mx-auto">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-8 py-6 text-left flex items-center justify-between hover:bg-accent/5 transition-colors duration-300"
              >
                <div className="flex items-center gap-3">
                  <faq.icon className="w-5 h-5 text-primary flex-shrink-0" />
                  <span className="text-xl text-foreground font-satoshi font-semibold">
                    {faq.question}
                  </span>
                </div>
              ...
              {openItems.includes(index) && (
                <div className="px-8 pb-6">
                  ...
                  <p className="text-foreground leading-relaxed font-satoshi">
                    {faq.answer}
                  </p>
                </div>
              )}
