...
const RusticInvitationReveal = ({ animationsEnabled }: RusticInvitationRevealProps) => {
  const polaroids = [
    { src: 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386103/Groom_pvr9re.jpg', alt: 'Groom' },
    { src: 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386085/Couple_shbkob.jpg', alt: 'Couple' },
    { src: 'https://res.cloudinary.com/dnlreax2z/image/upload/v1764386082/Bride_r2hpq4.jpg', alt: 'Bride' }
  ];
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen py-20 px-4" style={{ backgroundColor: 'transparent' }}>
      ...
      >
        ...
        {/* Main Container */}
        <div 
          className="relative bg-white p-12 md:p-16 rounded-sm overflow-hidden"
          style={{ boxShadow: '0 20px 60px rgba(59, 130, 246, 0.3), 0 0 30px rgba(59, 130, 246, 0.2)' }}
        >
          {/* Decorative corner accents */}
          <div className="absolute top-0 left-0 w-20 h-20" style={{ boxShadow: 'inset 2px 2px 10px rgba(59, 130, 246, 0.3)' }} />
          <div className="absolute top-0 right-0 w-20 h-20" style={{ boxShadow: 'inset -2px 2px 10px rgba(59, 130, 246, 0.3)' }} />
          <div className="absolute bottom-0 left-0 w-20 h-20" style={{ boxShadow: 'inset 2px -2px 10px rgba(59, 130, 246, 0.3)' }} />
          <div className="absolute bottom-0 right-0 w-20 h-20" style={{ boxShadow: 'inset -2px -2px 10px rgba(59, 130, 246, 0.3)' }} />
          ...
          <div className="text-center relative z-10 space-y-8">
            ...
            <div className="flex justify-center">
              <div className="relative w-20 h-20">
                ...
                <div className="relative w-full h-full rounded-full bg-white flex items-center justify-center" style={{ boxShadow: '0 4px 16px rgba(59, 130, 246, 0.25), inset 0 0 8px rgba(59, 130, 246, 0.1)' }}>
      ...
      <div className="relative z-10 flex flex-wrap items-center justify-center gap-8 max-w-6xl">
        ...
        >
          ...
          <div className="relative">
            ...
            {/* Main card */}
            <div 
              className="relative bg-white p-6 transition-all duration-300 rounded-sm"
              style={{ boxShadow: '0 12px 40px rgba(59, 130, 246, 0.25), 0 0 20px rgba(59, 130, 246, 0.15), 0 -4px 12px rgba(59, 130, 246, 0.2)' }}
            >
              {/* Top accent line */}
              ...
              <div className="mt-4 text-center relative">
                ...
                <p className="text-gray-700 text-sm font-medium tracking-wider uppercase font-satoshi">
                  {polaroid.alt}
                </p>
              </div>
            </div>
