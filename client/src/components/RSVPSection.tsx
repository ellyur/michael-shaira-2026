  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        >
          <h2 
            className="text-[48px] md:text-5xl text-[#3d668f]" 
        ...
        <div className="relative min-h-[700px] md:min-h-[800px] flex items-center justify-center">
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-4xl mx-auto">
            ...
            >
              <span 
                className="text-[150px] md:text-[240px] lg:text-[320px] leading-[0.8] tracking-tight block text-[#294056]"
            ...
            >
              <a 
                href="https://michael-shaira-rsvp.replit.app" 
                target="_blank" 
              ...
              <div className="mt-8 bg-white rounded-2xl p-8 max-w-2xl mx-auto shadow-2xl border border-gray-100">
                <p 
                  className="font-satoshi text-base md:text-lg text-black font-medium text-center mb-4"
